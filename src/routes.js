...
const MOBILE_ROUTES = new Set(['/', '/loading', '/curation', '/curation/topics', '/curation/connections', '/dashboard', '/companion', '/connections', '/companion/diff', '/companion/live', '/topic/courtcollect', '/topic/courtcollect/conversation/4']);
