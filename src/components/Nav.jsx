...
import { rowTight, mono } from '../styles/shared';
          ...
          <div ref={menuRef} style={{ position: "relative" }}>
            <button
              ...
              style={{
                ...
                color: C.gold, background: white(0.03),
                border: `1px solid ${white(0.08)}`, borderRadius: 10,
            ...
            >
              ...
              <span style={{ fontSize: 10, color: white(0.25), marginLeft: 2 }}>▾</span>
            </button>
            ...
            {menuOpen && (
              <div style={{
                ...
                minWidth: 200, boxShadow: `0 12px 40px ${black(0.6)}`,
              }}>
                {tabs.map(tab => (
                  <button
                    key={tab.id}
                    ...
                    style={{
                      ...
                      color: view === tab.id ? C.bg0 : white(0.5),
        ...
        {tabs.map(tab => (
          <button key={tab.id} onClick={() => onNavigate(tab.id)}
            ...
            style={{
              ...
              color: view === tab.id ? C.bg0 : white(0.4),
              background: view === tab.id ? C.gold : "transparent",
